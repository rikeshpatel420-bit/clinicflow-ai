...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-[#f7faf9] text-[#17211f]">
      <SiteHeader activePath="/terms" variant="public" />
      <section className="mx-auto max-w-[84rem] px-4 py-16 sm:px-6">
        <article className="max-w-3xl rounded-lg border border-[#dce6e3] bg-white p-8 shadow-sm">
          <p className="text-sm font-semibold text-[#087968]">Terms</p>
          <h1 className="mt-3 text-3xl font-semibold text-[#10201d]">Terms of Service</h1>
          <p className="mt-4 text-[0.98rem] leading-7 text-[#65736f]">
            This placeholder page is reserved for the production terms of service. It will explain acceptable use,
            billing, service limitations, and clinic responsibilities before launch.
          </p>
