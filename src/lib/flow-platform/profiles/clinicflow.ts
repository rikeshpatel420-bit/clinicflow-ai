...
const sharedLeadIntentDefinitions = [
  {
    ...
    followUpQuestion: "Of course. Could I have your name, mobile number, and the reason for getting in touch?",
    priority: 2,
  ...
  },
  {
    ...
    followUpQuestion: "Certainly. Could I have your name and the best number, and I'll make sure the right person can help?",
    priority: 4,
  ...
  },
  {
    ...
    followUpQuestion: "Of course. Could I have your name and the best number, and I'll take care of the rest?",
    priority: 3,
  ...
  },
  {
    ...
    followUpQuestion: "Absolutely. Could I have your contact details and preferred time, and I'll help get the right information for you?",
    priority: 2,
...
const voiceIntentDefinitions = [
  ...
  },
  {
    ...
    followUpQuestion: "Absolutely. Which treatment are you asking about, and what are the best contact details and time for me to follow up?",
    priority: 3,
  ...
  },
  {
    ...
    label: "Pricing enquiry",
    keywords: ["price", "pricing", "cost", "quote", "fee", "fees", "how much", "charge"],
    followUpQuestion: "Absolutely. Prices can vary depending on the assessment, so please share your contact details and preferred time and I’ll make sure it’s handled properly.",
    priority: 2,
    summaryHint: "Avoid quoting exact prices unless clinic-approved knowledge confirms them.",
  },
  {
    ...
    followUpQuestion: "I'm sorry that's been frustrating. Could I have your name, number, and what happened so I can handle it properly?",
    priority: 5,
  ...
  },
  {
    ...
    followUpQuestion: "Certainly. Could I have your name, number, and the message you'd like me to pass on?",
    priority: 1,
...
const treatmentIntentDefinitions = [
  ...
  },
  {
    ...
    followUpQuestion: "I'm sorry you're dealing with that. What time would suit you for me to call you back?",
    priority: 5,
...
export const clinicFlowPlatformProfile = defineFlowPlatformProfile({
  ...
  conversation: {
    ...
    voice: {
      ...
      greeting: "Good morning, and thank you for calling {{clinicName}}. You are through to ClinicFlow Dental reception. How can I help you today?",
