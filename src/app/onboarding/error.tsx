  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f7faf9] px-6 py-12 text-[#17211f]">
      <section className="w-full max-w-lg rounded-lg border border-red-200 bg-white p-8 shadow-xl shadow-slate-900/5">
        <p className="text-sm font-semibold text-red-700">Onboarding error</p>
        <h1 className="mt-3 text-3xl font-semibold text-[#10201d]">Could not load onboarding</h1>
        <p className="mt-3 leading-7 text-[#65736f]">
          Try again, then check Supabase settings if the issue continues.
        </p>
        <button
          type="button"
          onClick={reset}
